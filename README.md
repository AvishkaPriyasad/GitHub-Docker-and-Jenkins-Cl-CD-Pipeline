...
2. **Jenkins Build Trigger**: Jenkins, automation server, is configured to monitor the GitHub repository for changes. Upon detecting a new commit, Jenkins triggers the build process.
...
1. **Clone Repository**: Clone this repository to your local machine using the following command:
   ```
   git clone https://github.com/AvishkaPriyasad/GitHub-Docker-and-Jenkins-Cl-CD-Pipeline.git
   ```
